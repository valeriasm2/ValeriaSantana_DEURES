...
public class Exercici0013 {
    ...
    public static void showInformation(ArrayList<HashMap<String, Object>> cities) {
        ...
        int heightWidth = 7;
        int sealandWidth = 8;
        int totalWidth = idWidth + nameWidth + populationWidth + heightWidth + sealandWidth + 6;
        String columns = "|%-" + idWidth + "s|%-" + nameWidth + "s|%" + populationWidth + "s|%" + heightWidth + "s|%" + sealandWidth + "s|\n";
